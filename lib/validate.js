...
function validateValue(propPath, value, validation) {
  ...
  if (subtype) {
    ...
    value.forEach((subvalue, index) => {
      validateProp(propPath, value, { prop: `[${index}]`, type: subtype })
    })
  }
...
function validateProp(propPath, object, validation) {
  ...
  validateValue([propPath, prop], value, validation)
